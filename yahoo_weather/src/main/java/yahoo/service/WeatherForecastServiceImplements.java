...
import yahoo.view.YahooChannel;
import yahoo.view.YahooWeatherResponse;
...
public class WeatherForecastServiceImplements implements WeatherForecastService {
    ...
    private static final String WEATHER_QUEUE = "java:jboss/queue/weatherQueue";
    ...
    public void createAndSendMessage(String json) {
        ...
        City city = jsonService.readJsonMessage(json, City.class);
